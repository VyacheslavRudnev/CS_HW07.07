...
namespace Domain.Models
{
    public class Ex04_City
    {
        ...
        public Ex04_City(string _cityName):this()
        {
            this._cityName = _cityName;
        }
        public Ex04_City(string _cityName, string _countryName, int _population, string _phoneCode) : this()
        {
            this._cityName = _cityName;
        ...
        public Ex04_City(string _cityName, string _countryName, int _population, string _phoneCode, string[] _districts)
        {
            this._cityName = _cityName;
            this._countryName = _countryName;
            this._population = _population;
